...
class InstructionsForm(forms.Form):
    ...
    check5 = forms.BooleanField(label="The following names have been assigned to the SNP primers: "
                                "cg18849583, cg01268345, cg10333416, cg12925355, cg25542041 and cg02227036.", required=True)
